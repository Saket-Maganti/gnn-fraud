...
\end{aligned}
\]
All group risks, contract-level feasible-oracle risks, regret, and CVaR terms
...
contract encoder and router. Each oracle selects one feasible expert only
after whole-contract expert risks are formed; an instance-clairvoyant oracle
is diagnostic. Source-contract abstention capacities govern training and
